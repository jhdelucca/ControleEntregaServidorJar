...
class PedidoCargaService(val repository: PedidoCargaRepository) {
    ...
    fun getPedidosCoordenador(coordenadorRequest: VisaoCoordenadorRequest):List<PedidoCarga> {
        return repository.getPedidosCoordenador(coordenadorRequest.filial, coordenadorRequest.usuario,
            coordenadorRequest.dataInicio,coordenadorRequest.dataFim)
    }
